...
export default function Header() {
  ...
  return (
    <nav className="bg-white border-b border-slate-100 sticky top-0 z-50">
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b p-4 flex flex-col text-[10px] font-black uppercase tracking-widest space-y-2">
          <NavLink to="/" onClick={() => setIsOpen(false)} className="py-2 border-b border-slate-50">Beranda</NavLink>
