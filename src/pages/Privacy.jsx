...
export default function Privacy() {
  ...
  return (
    /* PERBAIKAN: Dari py-20 menjadi pt-20 pb-10 agar jarak bawah rapat & profesional */
    <div className="pt-20 pb-10 px-6 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-4 mb-12">
        ...
        <div>
          <h1 className="text-3xl font-black uppercase tracking-tighter text-slate-900 leading-none">Privacy Policy</h1>
          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.3em] mt-1">Data Anda, Kendali Anda</p>
        </div>
      </div>

      <p className="text-slate-600 mb-16 leading-relaxed text-sm md:text-base">
      ...
      <div className="grid gap-6">
        {points.map((p, i) => (
          <div key={i} className="flex gap-6 p-6 rounded-2xl border border-slate-100 bg-white hover:border-blue-100 transition-all shadow-sm">
